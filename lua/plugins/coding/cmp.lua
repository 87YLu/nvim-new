  ...
  config = function()
    ...
    cmp.setup({
      ...
      mapping = cmp.mapping.preset.insert({
        [PluginsKeyMapping.Cmp.nextItem.key] = cmp.mapping.select_next_item({ behavior = cmp.SelectBehavior.Insert }),
        [PluginsKeyMapping.Cmp.prevItem.key] = cmp.mapping.select_prev_item({ behavior = cmp.SelectBehavior.Insert }),
